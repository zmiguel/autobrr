...
func main() {
	...
	go func() {
		httpServer := http.NewServer(cfg, serverEvents, version, commit, date, actionService, authService, downloadClientService, filterService, indexerService, notificationService, ircService, releaseService)
